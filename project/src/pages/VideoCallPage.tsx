...
//       console.log("EX response:", result);
...
//       if (action === "no" || action === "-1" || action === "add") {
...
//   return (
//     <div className="p-4">
//       <div ref={callContainerRef} className="h-64 border mb-4 relative z-0" />
...
//             <p>No symptoms extracted from transcript yet.</p>
//           )}

//           {extractedSymptoms.length > 0 && !sessionId && (
//             <div>
//               <h4>Extracted Symptoms (EX):</h4>
...
//                 </label>
//               ))}
//               <button onClick={startSession}>Start Session (SP)</button>
//             </div>
//           )}

//           {sessionId && (
//             <div>
//               <h4>Session Symptoms</h4>
...
//                 <button onClick={() => sendDPAction("-1")}>Skip</button>
//                 <button onClick={() => sendDPAction("add")}>Add</button>
//                 <button onClick={() => sendDPAction("no")}>Predict Disease</button>
//               </div>
//               {predictedDisease && <p>Disease: {predictedDisease}</p>}
//             </div>
//           )}
//         </>
//       )}
